...
- `tk dep <id> <depends-on-id>` - Add dependency (first ticket depends on second)
- `tk undep <id> <depends-on-id>` - Remove dependency
- `tk link <id> [id...]` - Create symmetric link between tickets (bidirectional)
