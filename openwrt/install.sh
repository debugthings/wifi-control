...
# Create or reset wifi-control login
LOGIN_INDEX=""
i=0
...
# Hash the password. Note: $p$name means "use /etc/shadow for system user name",
# NOT plaintext — so we must store a crypt hash ($1$... from uhttpd -m / openssl).
